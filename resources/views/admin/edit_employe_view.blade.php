...
@section('content')
    ...
    <div class="right_col" role="main">
      ...
      <form method="post" action = "{{url('/')}}/admin/home/edit/employe/{{$result[0]->pk_id}}" class="login-form" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      @if($errors->any())
    ...
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
      <div class="createadmininputs">
           <div class="form-group">
                  <label for="usr">Employe Name</label>
                  <input type="text" value="{{$result[0]->employe_name}}" name="employe_name" class="form-control" id="usr">
                </div>
          </div>
    </div>
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
   ...
   <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
      <div class="createadmininputs">
           <div class="form-group">
                  ...
                  <input type="text" value="{{$result[0]->email}}" name="ntn" class="form-control" id="" readonly>
                </div>
          </div>
    </div>
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
