    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="Adminprofilebox">
        ...
        <table id="example" class="table" cellspacing="0" width="100%">
            ...
            <a href="{{ url('/admin/home/print/accont/recieveable') }}" class="amountbtn btt btn">Print Preview</a>
             <a href="{{ url('/admin/home/print/accont/recieveable/download/pdf') }}" class="amountbtn btn btn">PDF</a>
...
<tr>
            ...
            <a href="{{url('/')}}/admin/home/view/sale/by/customer/name/deatiled/{{$results->pk_id}}"><strong>{{$results->customer_name}}</strong></a>
           </td>
            <!-- 1--30 -->
