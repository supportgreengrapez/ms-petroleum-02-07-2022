...
@section('content')
    ...
    <div class="right_col" role="main">
      ...
      <form method="post" action ="{{url('/')}}/admin/create/permissions" class="login-form" enctype="multipart/form-data">
    {{ csrf_field() }}
          ...
          <div class="chkboxdesign">
            <div class="checkboxes">
              <label for="">
                ...
                <input id="myCheckbox" class="checkbox" type="checkbox" value="1" name="bank_deposit"/>
               Bank Deposit</label>
            </div>
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="subcheckboxes">
                  <label for="">
                    <input id="myButton" disabled class="checkbox" value="1" type="checkbox" name=""/>
                    Edit</label>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="subcheckboxes">
                  <label for="">
                    <input id="myButton2" value="1" disabled class="checkbox" type="checkbox" name=""/>
                    Delete</label>
                </div>
              </div>
            </div>
          ...
          <div class="chkboxdesign">
            <div class="checkboxes">
              <label for="">
                ...
                <input id="myCheckbox" class="checkbox" type="checkbox" value="1" name="transfer_money"/>
