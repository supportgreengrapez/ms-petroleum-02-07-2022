...
@section('content')
    ...
    <div class="right_col" role="main">
      ...
      <form method="post" action = "{{url('/')}}/admin/home/add/employe" class="login-form" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      @if($errors->any())
    ...
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
      <div class="createadmininputs">
           <div class="form-group">
                  ...
                  <input type="text" name="employe_name" class="form-control" id="usr" required>
                </div>
          </div>
    </div>
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
