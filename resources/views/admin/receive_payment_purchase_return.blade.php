...
<div class="right_col" role="main">
  ...
  <form method="post" action ="{{url('/')}}/admin/home/create/purchase/return/payment/submit/{{$results->pk_id}}" class="login-form" enctype="multipart/form-data">
      ...
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
        <div class="createadmininputs">
          <div class="form-group">
            ...
            <select class="js-example-basic-single" name="account_type" >
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="createadmininputs">
              <div class="form-group">
                ...
                <input type="date" class="form-control"  value="{{$results->bill_date}}"  name="due_date" readonly>
              </div>
            </div>
          </div>
