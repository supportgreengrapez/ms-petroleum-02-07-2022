    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="viewadminhead">
                <h2>
                    <a href="{{url('/')}}/admin/home/view/sale/by/customer" class="amountbtn btn">Back</a> Create Invoice</h2>
            </div>
        </div>
      ...
      @if($result>0)
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="createadmininputs">
                    <div class="form-group">
                        <label for="mydate">Invoice Date</label>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="createadmininputs">
                    <div class="form-group">
                        <label for="mydate2">Due Date</label>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <div class="createadmininputs">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single" id="sku" name="sku[]" required="true">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <div class="createadmininputs">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single" id="name" name="item_name[]" required="true">
