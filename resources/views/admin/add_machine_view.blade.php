...
@section('content') 
    ...
    <div class="right_col" role="main">
      ...
      <form method="post" action = "{{url('/')}}/admin/home/add/machine/{{$id}}" class="login-form">
        ...
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          <div class="createadmininputs">
            <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="@if(count($result)>0) {{$result[0]->pump_name}}  @endif" name="pump_name" readonly>
            ...
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
              <div class="createadmininputs">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="usr" name="machine_name[]">
                </div>
              </div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
              <div class="createadmininputs">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="usr" name="closing_reading[]">
                </div>
              </div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
              <div class="createadmininputs">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" name="current_dip[]">
                </div>
              </div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
              <div class="plusbutton">
                <button type="button"class="add_buttonmachine plusbtn" title="Add field"><span class="glyphicon glyphicon-plus"></span></button>
              </div>
            </div>
          </div>
        </div>
