...
modalConfirm(function(confirm){
  if(confirm){
    ...
    $("#result").html("Delete Successfully");
  }
});
...
$(document).ready(function () {
  $('#myCheckbox').click(function () {
    $('#myButton').prop("disabled", !$("#myCheckbox").prop("checked")); 
	 $('#myButton2').prop("disabled", !$("#myCheckbox").prop("checked")); 
  })
});
...
$(document).ready(function () {
  $('#adminCheckbox').click(function () {
    $('#admincheckbox1').prop("disabled", !$("#adminCheckbox").prop("checked")); 
	   $('#admincheckbox2').prop("disabled", !$("#adminCheckbox").prop("checked")); 
  })
});
...
$(document).ready(function () {
  $('#expenseCheckbox').click(function () {
    $('#expensecheckbox1').prop("disabled", !$("#expenseCheckbox").prop("checked")); 
	  $('#expensecheckbox2').prop("disabled", !$("#expenseCheckbox").prop("checked")); 
  })
});
...
$(document).ready(function () {
  $('#customerCheckbox').click(function () {
    $('#customercheckbox1').prop("disabled", !$("#customerCheckbox").prop("checked")); 
	 $('#customercheckbox2').prop("disabled", !$("#customerCheckbox").prop("checked")); 
  })
});

$(document).ready(function () {
  $('#salesCheckbox').click(function () {
    $('#salescheckbox1').prop("disabled", !$("#salesCheckbox").prop("checked")); 
	$('#salescheckbox2').prop("disabled", !$("#salesCheckbox").prop("checked")); 
  })
});
...
$(document).ready(function () {
  $('#supplierCheckbox').click(function () {
    $('#suppliercheckbox1').prop("disabled", !$("#supplierCheckbox").prop("checked")); 
	$('#suppliercheckbox2').prop("disabled", !$("#supplierCheckbox").prop("checked")); 
  })
});
...
$(document).ready(function () {
  $('#purchaseCheckbox').click(function () {
    $('#purchasecheckbox1').prop("disabled", !$("#purchaseCheckbox").prop("checked")); 
	$('#purchasecheckbox2').prop("disabled", !$("#purchaseCheckbox").prop("checked")); 
  })
});
...
$(document).ready(function () {
  $('#categoryCheckbox').click(function () {
    $('#categorycheckbox1').prop("disabled", !$("#categoryCheckbox").prop("checked")); 
	$('#categorycheckbox2').prop("disabled", !$("#categoryCheckbox").prop("checked")); 
  })
});
...
$(document).ready(function () {
  $('#reportCheckbox').click(function () {
    $('#reportcheckbox1').prop("disabled", !$("#reportCheckbox").prop("checked")); 
	$('#reportcheckbox2').prop("disabled", !$("#reportCheckbox").prop("checked")); 
  })
});

$(document).ready(function () {
  $('#itemCheckbox').click(function () {
    $('#itemcheckbox1').prop("disabled", !$("#itemCheckbox").prop("checked")); 
	$('#itemcheckbox2').prop("disabled", !$("#itemCheckbox").prop("checked")); 
  })
});


$(document).ready(function () {
  $('#kachiCheckbox').click(function () {
    $('#kachicheckbox1').prop("disabled", !$("#kachiCheckbox").prop("checked")); 
	$('#kachicheckbox2').prop("disabled", !$("#kachiCheckbox").prop("checked")); 
  })
});


$(document).ready(function () {
  $('#pumpCheckbox').click(function () {
    $('#pumpcheckbox1').prop("disabled", !$("#pumpCheckbox").prop("checked")); 
	$('#pumpcheckbox2').prop("disabled", !$("#pumpCheckbox").prop("checked")); 
  })
});

$(document).ready(function () {
  $('#accountCheckbox').click(function () {
    $('#accountcheckbox1').prop("disabled", !$("#accountCheckbox").prop("checked")); 
	$('#accountcheckbox2').prop("disabled", !$("#accountCheckbox").prop("checked")); 
  })
});
...
$(document).ready(function(){
    ...
    var addButton = $('.add_buttonmaterial'); //Add button selector
    var wrapper = $('.field_wrapper'); //Input field wrapper
    var fieldHTML = '  <div class="borderrow"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Material Name</label><input type="text" class="form-control" id="usr"></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 col-lg-offset-1"><div class="createadmininputs"><div class="form-group"><label for="usr">Description</label><input type="text" class="form-control" id="usr"></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 col-lg-offset-1"><div class="createadmininputs"><h5>Amount</h5><p>10,000</p></div></div><a href="javascript:void(0);" class="remove_button plusbtn"><span class="glyphicon glyphicon-minus marginsets"></span></a></div>'; //New input field html 
...
$(document).ready(function(){
    var maxField = 10; //Input fields increment limitation
    var addButton = $('.add_buttondaybook'); //Add button selector
    var wrapper = $('.field_wrapper'); //Input field wrapper
    var fieldHTML = ' <div class="field_wrapper"><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="sel1">Customer Name</label><select class="form-control" id=""><option>Ahmad</option><option>Usama</option><option>Ali</option><option>Talha</option><option>Ibrahim</option><option>Danish</option><option>Faizan</option></select></div></div></div><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="sel1">Account Type</label><select class="form-control" id=""><option>Credit</option><option>Debit</option><option>Paypal</option><option>Cash</option></select></div></div></div><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Description</label><input type="text" class="form-control" id="usr"></div></div></div><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Amount</label><input type="text" class="form-control" id=""></div></div></div><a href="javascript:void(0);" class="remove_button plusbtn"><span class="glyphicon glyphicon-minus marginsets"></span></a></div>'; //New input field html 
    var x = 1; //Initial field counter is 1
...
$(document).ready(function(){
    var maxField = 10; //Input fields increment limitation
    var addButton = $('.add_buttondaybok'); //Add button selector
    var wrapper = $('.field_wrapper'); //Input field wrapper
    var fieldHTML = ' <div class="field_wrapper"><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="sel1">Supplier Name</label><select class="form-control" id=""><option>Ahmad</option><option>Usama</option><option>Ali</option><option>Talha</option><option>Ibrahim</option><option>Danish</option><option>Faizan</option></select></div></div></div><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="sel1">Account Type</label><select class="form-control" id=""><option>Credit</option><option>Debit</option><option>Paypal</option><option>Cash</option></select></div></div></div><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Description</label><input type="text" class="form-control" id="usr"></div></div></div><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Amount</label><input type="text" class="form-control" id=""></div></div></div><a href="javascript:void(0);" class="remove_button plusbtn"><span class="glyphicon glyphicon-minus marginsets"></span></a></div>'; //New input field html 
    var x = 1; //Initial field counter is 1
...
$(document).ready(function(){
    var maxField = 10; //Input fields increment limitation
    var addButton = $('.add_buttondaybook3'); //Add button selector
    var wrapper = $('.field_wrapper'); //Input field wrapper
    var fieldHTML = '<div class="field_wrapper"><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"> <label for="sel1">Expense Type</label><select class="form-control" id=""><option>Zakat</option><option>Office</option><option>Others</option></select></div></div></div><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="sel1">Payment Account</label><select class="form-control" id=""><option>Credit</option><option>Debit</option><option>Paypal</option><option>Cash</option></select></div></div></div><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Description</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Amount</label><input type="text" class="form-control" id=""></div></div></div><a href="javascript:void(0);" class="remove_button plusbtn"><span class="glyphicon glyphicon-minus marginsets"></span></a></div>'; //New input field html 
    var x = 1; //Initial field counter is 1
...
$(document).ready(function(){
    var maxField = 10; //Input fields increment limitation
    var addButton = $('.add_buttonccp'); //Add button selector
    var wrapper = $('.field_wrapper'); //Input field wrapper
    var fieldHTML = '<div class="borderrow"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Supplier Name</label><input type="text" class="form-control" id="usr"></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Company Name</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Vehicle No</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Quantity</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="sel1">UOM</label><select class="form-control" id=""><option>Liter</option<option>2 Liter</option></select></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Rate</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Slip #</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><h5>Amount</h5><p>10,000</p></div></div><a href="javascript:void(0);" class="remove_button plusbtn"><span class="glyphicon glyphicon-minus marginsets"></span></a></div>'; //New input field html 
    var x = 1; //Initial field counter is 1
...
$(document).ready(function(){
    var maxField = 10; //Input fields increment limitation
    var addButton = $('.add_buttonccs'); //Add button selector
    var wrapper = $('.field_wrapper'); //Input field wrapper
...
$(document).ready(function(){
    var maxField = 10; //Input fields increment limitation
    var addButton = $('.add_buttoncpsr'); //Add button selector
    var wrapper = $('.field_wrapper'); //Input field wrapper
    var fieldHTML = '  <div class="borderrow"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Machine Name</label><input type="text" class="form-control" id="usr"></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Previous Reading</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Current Reading</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Sale</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Rate</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-1 col-md-1 col-sm-12 col-xs-12"><div class="createadmininputs"><h5>Amount</h5><p>10,000</p></div></div><a href="javascript:void(0);" class="remove_button plusbtn"><span class="glyphicon glyphicon-minus marginsets"></span></a></div>'; //New input field html 
    var x = 1; //Initial field counter is 1
...
$(document).ready(function(){
    var maxField = 10; //Input fields increment limitation
    var addButton = $('.add_buttoncpr'); //Add button selector
    var wrapper = $('.field_wrapper'); //Input field wrapper
    var fieldHTML = '<div class="borderrow"><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">SKU</label><input type="text" class="form-control" id="usr"></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Item Name</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">VCompany Name</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Vehicle No</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Quantity</label><input type="text" class="form-control" id="usr"></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><div class="form-group"><label for="usr">Rate</label><input type="text" class="form-control" id=""></div></div></div><div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"><div class="createadmininputs"><h5>Amount</h5><p>10,000</p></div></div><a href="javascript:void(0);" class="remove_button plusbtn"><span class="glyphicon glyphicon-minus marginsets"></span></a></div>'; //New input field html 
    var x = 1; //Initial field counter is 1
