        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="plusbutton"> <a href="{{URL('/')}}/admin/home/add/purchase" class="btn pumpplusbtn" title="Add field"><span class="glyphicon glyphicon-plus"></span></a> </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                @endphp
                  <tr>
                    ...
                    <td>PKR {{number_format($total_sale[0]->{'SUM(total_amount)'})}}</td>
                       <td><a href="{{url('/')}}/admin/home/view/purchase/return/{{$results->pk_id}}">{{count($invoice)}} Invoice</a></td>
