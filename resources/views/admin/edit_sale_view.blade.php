...
<form method="post" action = "{{url('/')}}/admin/home/edit/sale/{{$result1[0]->pk_id}}" class="login-form" enctype="multipart/form-data">
    ...
    <div class="right_col" role="main">
      ...
      <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          @foreach($customer as $results)
                  <option value="{{$results->pk_id}}" @if($results->pk_id == $result1[0]->customer_name) selected @endif >{{$results->customer_name}}</option>
                  @endforeach
                  @endif
              </select>
                </div>
        ...
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
          ...
          <div class="createadmininputs">
            <div class="form-group">
                ...
                <option value="sale" @if($result1[0]->sale_type == 'sale') selected @endif>Sale</option>
                <option value="sale return" @if($result1[0]->sale_type == 'sale return') selected @endif>Sale Return</option>
              </select>
                </div>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
         ...
         <div class="invoicestopright">
         <h4>Bills #</h4>
          <p id="bills">{{$result1[0]->customer_name}}</p>
         </div>
