...
<div class="right_col" role="main">
  ...
  <form method="post" action ="{{url('/')}}/admin/home/add/purchase/invioce/return/{{$id}}" class="login-form" enctype="multipart/form-data">
    {{ csrf_field() }}
      ...
      <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
        <div class="createadmininputs">
          <div class="form-group">
           ...
           @php
$cus_name= $result[0]->supplier_name;
                    $supplier_name = DB::select("select* from supplier where pk_id = '$cus_name'");
                 
           @endphp


            <input  class=" form-control"  id="customer_name" name="supplier_name"  value= "{{$supplier_name[0]->supplier_name}}" readonly>
    ...
    <div class="row">
        ...
        <div class="createadmininputs">
          <div class="form-group">
            ...
            <input  class=" form-control"  id="sale_type" name="sale_type" value="{{$result[0]->purchase_type}}" readonly>
          </div>
        </div>
      </div>
