      ...
      <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 col-lg-offset-2">
          <div class="Adminprofilebox">
            ...
            <a href="{{ url('/admin/home/inventory/print') }}" class="amountbtn btt btn">Print Preview</a>
          <a href="{{ url('admin/home/view/inventory/report/download/pdf') }}" class="amountbtn btn btn">PDF</a>
                ...
                <tr> 
                  <td><a href="{{url('/')}}/admin/home/view/inventory/detail/{{$results->pk_id}}" >{{$results->sku}}</td>
                   <td>{{$results->name}}</td>
