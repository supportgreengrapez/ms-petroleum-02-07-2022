    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="viewadminhead">
                <h2>Create Supplier Creditor/Debitor</h2>
            </div>
        </div>
    </div>
    <form method="post" action="{{url('/')}}/admin/add/payment/supplier" class="login-form">
        {{ csrf_field() }}
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="createadmininputs">
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-single" id="suppliername" name="suppliername">
                            ...
                            <option value="{{$results->pk_id}}">{{$results->supplier_name}} |
